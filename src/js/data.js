...
function populateUnits() {
	...
	units.push({id: 1, name: 'Artillery', type: 1, subType: 'vehicle', cost: 5, move: 1, att: 2, numAtt: 3, def: 1, cas: 5, returnFlg: true, spotterReq: true, desc: ['These are special attack weapons that have very limited defense capabilities. Artillery units attack into an adjacent territory without actually entering it. Each unit rolls 3 dice and a hit is scored for each roll of 2 or lower. They attack at the same time as the other attacking units, but are only used in the first round of battle. Artillery cannot be hit when attacking and remain in their original territory during and after the battle.','Extra dice added for Rocketry, Chemical Warheads and Anthrax Warheads technologies.','Can also fire into water, doing 1/3 as many hits as on land.']});
	...
	units.push({id: 20, name: 'Humvee', type: 1, subType: 'vehicle', target: 'soldierOnly', cost: 4, move: 2, att: 2, numAtt: 1, def: 5, numDef: 1, cas: 5, flag: 1, desc: ['Cheap, mobile units with a strong defense against soldiers but cannot target other types of units (except for drones).','Target Predator Drones when defending.']});
	...
	units.push({id: 22, name: 'Mig 29', type: 2, subType: 'fighter', cost: 4, move: 2, att: 3, numAtt: 1, def: 2, cas: 4, flag: 3, returnFlg: true, desc: ['Inexpensive unit with half the range and same attack as a fighter, but for half the cost. They also defend against Predator Drones.','+1 defense and immune to AA with Stealth, increased range with "Long Range Aircraft" technology, and +1 attack (4) with Maverick Missiles tech.']});
	...
	units.push({id: 28, name: 'Medic', type: 1, subType: 'soldier', cost: 5, move: 1, att: 1, numAtt: 1, def: 1, cas: 5, flag: 1, desc: ['Heals 1 infantry casualty per battle on offense or defense. When used for attacks, medics will return to previous country after healing a unit. Once used, he will be frozen for the rest of this round and all of next round, not able to heal, move or fight.','Medics cannot attack from transports, and do not heal against nukes or EMPs.']});
	...
	units.push({id: 30, name: 'Stinger Soldier', type: 1, subType: 'soldier', target: 'planes', cost: 3, move: 1, att: 2, numAtt: 1, def: 2, cas: 3, flag: 3, desc: ['Stinger soldiers provide a strong defense against aircraft as they will target planes first, but can hit any piece encountered.','Also can target Predator Drones when defending.']});
	...
	units.push({id: 33, name: 'Scud Launcher', type: 1, subType: 'vehicle', cost: 8, move: 1, att: 3, numAtt: 4, def: 1, cas: 8, flag: 6, returnFlg: true, desc: ['Fights like artillery, but with 4 dice needing "3"s to hit. Upgradable with technology. Requires infantry or tank spotters.','Extra dice added for Rocketry, Chemical Warheads and Anthrax Warheads technologies.','Can also fire into water, doing 1/3 as many hits as on land.']});
	units.push({id: 34, name: 'Rocket Buggie', type: 1, subType: 'vehicle', target: 'vehicles', cost: 6, move: 2, att: 4, numAtt: 1, def: 4, cas: 6, flag: 7, desc: ['Strong attack piece that targets tanks and artillery (not specialty units) when fighting.','Also can target Predator Drones when defending.','Extra attack dice with Anthrax tech.']});
	...
	units.push({id: 40, name: 'Battlemaster', type: 1, subType: 'vehicle', target: 'vehicles', cost: 12, move: 1, att: 4, numAtt: 3, def: 4, numDef: 2, cas: 10, flag: 5, desc: ['This is most powerful land unit in the game. Battlemaster tanks will mow down multiple units with a powerful attack and defense. In addition, these units come equiped with an AA gun built in.','Also can target Predator Drones when defending.','Gain an extra attack dice with Anthrax tech.']});
