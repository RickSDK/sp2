...
function getCampaigns() {
	return [
		...
		{ id: 2, name: 'Heros!', capitalsWin: 2, lock: true, currentFlg: false, unit: 10, type: 'freeforall', numPlayers: 2, desc: 'Repeat of Campaign #1, but now with all ground units unlocked.', mission: 'Begin the conquest! It\'s time to expand your empire. Click on Ukraine to invade.' },
		{ id: 3, name: 'Bombers', capitalsWin: 2, lock: true, currentFlg: false, unit: 7, type: 'freeforall', numPlayers: 2, desc: 'Learn the art of strategic bombings and paratroopers.', mission: 'Your mission is to bomb Russia\'s economy and protect your own. The first player to reduce his enemy\'s income to under 20 coins wins!',
		...
		{ id: 6, name: 'Tech War', capitalsWin: 3, lock: true, currentFlg: false, unit: 18, type: 'freeforall', numPlayers: 3, desc: 'Technology unlocked. Attempt to take over 3 capitals against multiple opponents.', mission: 'We now introduce you to technology, which can be a game changer. Read the technology tab for details. This is a full blown game and your objective is to claim 3 capitals.' },
