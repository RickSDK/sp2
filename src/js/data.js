...
function getCampaigns() {
	return [
		...
		{ id: 9, name: 'Hard Fog', capitalsWin: 5, lock: true, currentFlg: false, unit: 6, type: 'diplomacy', numPlayers: 4, desc: 'You thought fog of war was tough, wait until you play with hard fog.', mission: 'Hard fog has even more information hidden from you. Team up and control 5 capitals to win the game.' },
